...
class InputReceivedPayload(EventPayload):
    ...
    user_input: str
    input_id: Optional[str] = None # This is the ID generated by InputHandler
    timestamp: Optional[str] = None
    correlation_id: Optional[str] = None # For external ID, e.g., from E2E C# client
    reply_to_e2e: Optional[str] = None   # For E2E C# client to get direct response
...
class MemoryRetrievedPayload(EventPayload):
    ...
    reply_to_e2e: Optional[str] = None
